...
class IdentificationNumberVerification implements Verification
{
    ...
    {
        return $this->genderMatchesIdentificationNumber($person)
    ...
    private function genderMatchesIdentificationNumber(Person $person): bool
    {
        ...
        if ($secondLast % 2 === 0) {
            return strtolower($person->gender()) === Person::GENDER_FEMALE;
        }

        return strtolower($person->gender()) === Person::GENDER_MALE;
    }
